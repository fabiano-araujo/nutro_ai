...
final Map<String, String> ptBRTranslations = {
  ...
  'profile_tracking_apps_subtitle':
      'Sincronize atividades com o Health Connect',
  ...
  'select_text_title': 'Selecionar Texto',
  'copy_all': 'Copiar Tudo',
  'speak_aloud': 'Ler em voz alta',
  'regenerate_response': 'Gerar resposta novamente',
  'save_and_resend': 'Salvar e reenviar',
  'wait_response_before_edit': 'Aguarde a resposta terminar antes de editar.',
  'wait_response_before_delete':
      'Aguarde a resposta terminar antes de excluir.',
  'message_required_before_resend': 'Digite uma mensagem antes de reenviar.',
  'message_edit_failed': 'Não foi possível editar a mensagem agora.',
  'voice_unavailable': 'Função de leitura não disponível no momento.',
  ...
  'subscription_annual_savings_amount': '{amount} de economia',
  ...
  'diary_calories_burned_short': 'Gastas',
  'exceeded': 'excesso',
  'protein': 'Proteínas',
  'protein_short': 'Prot',
  'carbs': 'Carboidratos',
  ...
  'estimated': 'estimado',
  'nutrition_tips': 'Análise da IA',
  'nutrition_tips_description':
      'A nutricionista virtual avalia o equilíbrio desta refeição e sugere um próximo passo prático.',
  'get_ai_tips': 'Analisar refeição',
  'refresh_tips': 'Analisar de novo',
  'positive_points': 'O que está bom',
  'can_improve': 'Como melhorar',
  'analyzing_meal': 'Analisando a refeição...',
  'meal_tips_error': 'Não foi possível gerar as dicas agora.',
  'meal_ai_next_step': 'Próximo passo',
  'meal_foods_empty': 'Nenhum alimento nesta refeição',
  ...
  'calorie_editor_title': 'Editar calorias',
  'calorie_editor_subtitle':
      'Defina sua meta diária. O app compara o valor com suas calorias de manutenção antes de atualizar o objetivo.',
  'calorie_editor_daily_target': 'Meta diária de calorias',
  'calorie_editor_invalid_value': 'Informe um valor entre 500 e 10.000 kcal.',
  'calorie_editor_maintenance_label': 'Calorias de manutenção estimadas',
  'calorie_editor_maintenance_hint':
      'Calculadas com sexo, idade, peso, altura e nível de atividade informados.',
  'calorie_editor_result_title': 'Com essa meta, seu objetivo será',
  'calorie_editor_goal_lose_fast': 'Emagrecer rapidamente',
  'calorie_editor_goal_lose_slowly': 'Emagrecer devagar',
  'calorie_editor_goal_maintain': 'Manter o peso',
  'calorie_editor_goal_gain_slowly': 'Ganhar peso devagar',
  'calorie_editor_goal_gain_fast': 'Ganhar peso rapidamente',
  'calorie_editor_difference':
      'Essa meta fica {percent}% {direction} das suas calorias de manutenção.',
  'calorie_editor_difference_neutral':
      'Essa meta está próxima das suas calorias de manutenção.',
  'calorie_editor_direction_below': 'abaixo',
  'calorie_editor_direction_above': 'acima',
  'calorie_editor_macros_hint':
      'Os macros serão recalculados mantendo a distribuição atual.',
  'calorie_editor_confirm': 'Confirmar meta e objetivo',
  'calorie_editor_saved': 'Calorias e objetivo atualizados com sucesso!',
  ...
  'water': 'Água',
  'water_glasses': 'copos',
  'water_challenge': 'Desafio Água',
  'water_goal': 'Meta',
  'water_goal_dialog_title': 'Desafios',
  'water_goal_dialog_subtitle': 'Acompanhe seu consumo diário',
  'water_daily_goal': 'Meta diária',
  'water_glasses_title': 'Copos',
  'water_recommended': 'Recomendado',
  'water_confirm': 'Confirmar',
  'water_above_recommended_warning':
      'Acima do recomendado para você ({amount}).',
  ...
  'activity_screen_title': 'Atividade',
  'activity_tab_recent': 'Recentes',
  'activity_tab_all': 'Todas atividades',
  'activity_tab_mine': 'Minhas atividades',
  'activity_search_hint': 'Procurar uma atividade',
  'activity_no_results': 'Nenhuma atividade encontrada.',
  'activity_no_recent': 'Você ainda não registrou atividades recentes.',
  'activity_no_custom': 'Você ainda não criou atividades personalizadas.',
  'activity_create_custom': 'Criar atividade',
  'activity_custom_name': 'Nome da atividade',
  'activity_custom_name_invalid': 'Digite um nome com pelo menos 2 caracteres.',
  'activity_intensity': 'Intensidade',
  'activity_intensity_light': 'Leve',
  'activity_intensity_moderate': 'Moderada',
  'activity_intensity_intense': 'Intensa',
  'activity_delete_custom_title': 'Excluir atividade?',
  'activity_delete_custom_message':
      'A atividade “{name}” será removida da sua lista. Os registros anteriores serão mantidos.',
  'activity_duration': 'Duração',
  'activity_calories': 'Calorias gastas',
  'activity_calories_estimated':
      'Estimativa baseada no seu peso e na intensidade.',
  'activity_invalid_duration': 'Informe uma duração entre 1 e 1.440 minutos.',
  'activity_invalid_calories': 'Informe um valor válido de calorias.',
  'activity_save': 'Registrar atividade',
  'activity_saved': 'Atividade adicionada ao Diário.',
  'activity_daily_message':
      'Caminhe ou registre uma atividade física para calcular suas calorias gastas.',
  'activity_name_abdominals': 'Abdominais',
  'activity_name_aerobics': 'Aeróbico',
  'activity_name_squat': 'Agachamento',
  'activity_name_aikido': 'Aikido',
  'activity_name_stretching': 'Alongamento',
  'activity_name_masonry': 'Alvenaria',
  'activity_name_aquagym': 'Aquagym',
  'activity_name_archery': 'Arco e flecha',
  'activity_name_badminton': 'Badminton',
  'activity_name_pull_ups': 'Barra fixa',
  'activity_name_basketball': 'Basquete',
  'activity_name_baseball': 'Beisebol',
  'activity_name_walking': 'Caminhada',
  'activity_name_running': 'Corrida',
  'activity_name_cycling': 'Ciclismo',
  'activity_name_swimming': 'Natação',
  'activity_name_weight_training': 'Musculação',
  'activity_name_football': 'Futebol',
  'activity_name_yoga': 'Yoga',
  'activity_name_pilates': 'Pilates',
  'activity_name_dance': 'Dança',
  'activity_name_boxing': 'Boxe',
  'activity_name_crossfit': 'CrossFit',
  'activity_name_elliptical': 'Elíptico',
  'activity_name_rowing': 'Remo',
  'activity_name_jump_rope': 'Pular corda',
  ...
  'tracking_permission_active_calories': 'Calorias gastas',
  ...
  'tracking_desc_polar_health_connect':
      'Ative o Health Connect nas configurações gerais do Polar Flow.',
  'tracking_source_data_detected': 'Dados detectados hoje',
  'tracking_action_open': 'Abrir',
  'tracking_action_install': 'Instalar',
  'tracking_installed': 'Instalado',
  'tracking_store': 'Loja oficial',
  'tracking_app_opened': 'Abrindo {app}.',
  'tracking_app_store_opened': 'Abrindo a loja oficial para instalar {app}.',
